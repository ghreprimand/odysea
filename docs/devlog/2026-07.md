# OdySea devlog — 2026-07

Archived entries from the OdySea development record for July 2026, in the same
order and wording as when they were published. Archived entries are never
edited. See `../../DEVLOG.md` for the live record and the full archive index.
